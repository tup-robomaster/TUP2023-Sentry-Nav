...
bool KeyFrame::findConnection(KeyFrame* old_kf)
{
	...
	*/
	...
	if ((int)matched_2d_cur.size() > MIN_LOOP_NUM)
	{
	    ...
	    std::cout<<"Relative Yaw: "<<relative_yaw<<" , Relative Dist: "<<relative_t.norm()<<std::endl;
	    if ((abs(relative_yaw) < 30.0 && relative_t.norm() < 20.0) || abs(relative_yaw) < 60.0 && relative_t.norm() < 3.0)
	    {
