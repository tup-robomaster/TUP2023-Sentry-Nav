...
void process()
{
    while (true)
    {
        ...
        if(!image_buf.empty() && !point_buf.empty() && !pose_buf.empty())
        {
            ...
            {
                // std::cout<<"IMG: "<<image_buf.front()->header.stamp.sec <<"."<< image_buf.front()->header.stamp.nanosec<<std::endl;
                // std::cout<<"POSE: "<<pose_buf.front()->header.stamp.sec <<"."<< pose_buf.front()->header.stamp.nanosec<<std::endl;
                pose_buf.pop();
